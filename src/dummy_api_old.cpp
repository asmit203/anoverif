...
#include <mutex>
#inclu        static MHD_Result request_handler(void *cls, s        MHD_Result handle_verify_request(struct MHD_Connection *connection,
                                  const char *upload_data, size_t *upload_data_size,
                                  void **con_cls)ct MHD_Connection *connection,
        ...
        MHD_Result handle_request(struct MHD_Connection *connection, const char *url,#include <chrono>
#include <signal.h>
#include <cstring>
...
namespace anoverif
{
    ...
    private:
        ...
        int handle_verify_request(struct MHD_Connection *connection,
                                  const char *upload_data, size_t *upload_data_size,
                                  void **con_cls)
        {
